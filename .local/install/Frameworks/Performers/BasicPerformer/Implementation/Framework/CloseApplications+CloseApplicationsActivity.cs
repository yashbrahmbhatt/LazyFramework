...
namespace LazyFramework.DX.Shared.Frameworks.Performers.BasicPerformer.Implementation.Framework
{
    ...
    internal class CloseApplicationsActivityChild : UiPath.CodedWorkflows.AsyncTaskCodedWorkflowActivity
    {
        ...
        protected override async System.Threading.Tasks.Task<Action<AsyncCodeActivityContext>> ExecuteAsync(AsyncCodeActivityContext context, System.Threading.CancellationToken cancellationToken)
        {
            ...
            var codedWorkflow = new global::LazyFramework.DX.Shared.Frameworks.Performers.BasicPerformer.Implementation.Framework.CloseApplications();
            ...
            var result = await System.Threading.Tasks.Task.Run(() => CodedWorkflowHelper.RunWithExceptionHandlingAsync(() =>
            {
                if (codedWorkflow is IBeforeAfterRun codedWorkflowWithBeforeAfter)
                {
                    ...
                    {RelativeFilePath = "Frameworks\\Performers\\BasicPerformer\\Implementation\\Framework\\CloseApplications.cs"});
                }
            ...
            }, (exception, outArgs) =>
            {
                if (codedWorkflow is IBeforeAfterRun codedWorkflowWithBeforeAfter)
                {
                    ...
                    {RelativeFilePath = "Frameworks\\Performers\\BasicPerformer\\Implementation\\Framework\\CloseApplications.cs", Exception = exception});
                }
