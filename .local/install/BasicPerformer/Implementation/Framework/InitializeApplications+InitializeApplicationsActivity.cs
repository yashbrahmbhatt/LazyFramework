...
namespace LazyFramework.DX.Shared.BasicPerformer.Implementation.Framework
{
    ...
    public class InitializeApplicationsActivity : System.Activities.Activity
    {
        ...
        public InitializeApplicationsActivity()
        {
            this.Implementation = () =>
            {
                return new InitializeApplicationsActivityChild()
    ...
    internal class InitializeApplicationsActivityChild : UiPath.CodedWorkflows.AsyncTaskCodedWorkflowActivity
    {
        public InArgument<LazyFramework.DX.Shared.BasicPerformer.Implementation.StateData> state { get; set; }
        ...
        public InitializeApplicationsActivityChild()
        {
            DisplayName = "InitializeApplications";
        }
        ...
        protected override async System.Threading.Tasks.Task<Action<AsyncCodeActivityContext>> ExecuteAsync(AsyncCodeActivityContext context, System.Threading.CancellationToken cancellationToken)
        {
            ...
            var codedWorkflow = new global::LazyFramework.DX.Shared.BasicPerformer.Implementation.Framework.InitializeApplications();
            ...
            var result = await System.Threading.Tasks.Task.Run(() => CodedWorkflowHelper.RunWithExceptionHandlingAsync(() =>
            {
                if (codedWorkflow is IBeforeAfterRun codedWorkflowWithBeforeAfter)
                {
                    ...
                    {RelativeFilePath = "BasicPerformer\\Implementation\\Framework\\InitializeApplications.cs"});
                }
            ...
            }, (exception, outArgs) =>
            {
                if (codedWorkflow is IBeforeAfterRun codedWorkflowWithBeforeAfter)
                {
                    ...
                    {RelativeFilePath = "BasicPerformer\\Implementation\\Framework\\InitializeApplications.cs", Exception = exception});
                }
