# KillProcessesSuccess
Class: KillProcessesSuccess

Tests that all processes are killed successfully.
...
Sequence_1: Sequence - KillProcessesSuccess
state Sequence_1 {
direction TB
...
InvokeWorkflowFile_3 : InvokeWorkflowFile - Load Config
MultipleAssign_2 --> InvokeWorkflowFile_3
InvokeWorkflowFile_4 : InvokeWorkflowFile - .templates\\Dispatchers\\Application\\Framework\\InitializeApplications.xaml - Invoke Workflow File
InvokeWorkflowFile_3 --> InvokeWorkflowFile_4
}
...
state Sequence_3 {
direction TB
InvokeWorkflowFile_1 : InvokeWorkflowFile - KillProcesses.xaml - Invoke Workflow File
}
}
