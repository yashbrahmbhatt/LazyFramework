...
Sequence_1: Sequence - TestCaseTemplate
state Sequence_1 {
direction TB
...
InvokeWorkflowFile_3 : InvokeWorkflowFile - InitializeApplications.xaml - Invoke Workflow File
...
state Sequence_3 {
direction TB
InvokeWorkflowFile_2 : InvokeWorkflowFile - CloseApplications.xaml - Invoke Workflow File
}
}
