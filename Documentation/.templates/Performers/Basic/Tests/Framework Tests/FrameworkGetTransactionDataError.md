# FrameworkGetTransactionDataError
Class: FrameworkGetTransactionDataError

Tests for a framework exception when GetTransactionData state has an error. Validates that the exception email is sent out.
...
Sequence_1: Sequence - FrameworkGetTransactionDataError
state Sequence_1 {
direction TB
